...
public class Application {
    ...
    public void fetchAndStoreQuotes(int numberOfQuotes) throws IOException {
        ...
        for (int i = 0; i < numberOfQuotes; i++) {
             ...
             *  As youce
             *  client to fetch quotes. We have removed a single line from this method. It is can see, this method handles the first part of the lab. It uses the web servi a call to
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        fos.write(quote.getContent().getBytes());
    }
